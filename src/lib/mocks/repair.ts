  ...
  diagnostic_steps: [
    {
      ...
      description: "Avant tout démontage, écarter la piste logicielle. Désinstaller proprement les drivers avec DDU puis réinstaller la dernière version stable.",
    ...
    {
      order: 2,
      title: "Stress test thermique et surveillance VRAM",
      description: "Lancer FurMark 10 minutes en surveillant les températures GPU et surtout VRAM via HWInfo64. Observer quand les artefacts apparaissent.",
    ...
    {
      order: 3,
      title: "Tester sur une autre configuration / alimentation",
      description: "Si possible, monter la carte sur un autre PC ou avec une autre alimentation pour isoler un problème d'alimentation électrique.",
      tools_needed: ["Multimètre", "Alimentation de test"],
      outcomes: [
  ...
  repair_procedures: [
    {
      ...
      steps: [
        "Télécharger DDU et la dernière version stable du driver constructeur.",
        "Démarrer en mode sans échec, lancer DDU et choisir « Nettoyer et redémarrer ».",
        "Réinstaller le driver propre une fois sous Windows.",
        "Relancer un jeu ou un benchmark pour valider.",
      ],
      materials: [],
    ...
    },
    {
      ...
      steps: [
        "Démonter le shroud et retirer le radiateur GPU.",
        "Nettoyer l'ancienne pâte à l'alcool isopropylique 99 %.",
        "Remplacer les thermal pads (mesurer l'épaisseur : 1.5 mm VRAM, 1 mm VRM).",
        "Appliquer une pâte thermique fraîche de qualité.",
        "Remonter et lancer un stress test 30 min pour valider les températures.",
      ],
      materials: [
        { name: "Pâte thermique MX-4", est_price_eur: 8 },
        { name: "Kit thermal pads 1.5 mm", est_price_eur: 12 },
    ...
    },
    {
      ...
      steps: [
        "Identifier la puce VRAM défaillante (test MATS ou observation des zones d'artefacts).",
        "Reball ou remplacement de la puce — nécessite station BGA et expérience.",
        "Si pas d'équipement : évaluer le coût d'une réparation pro vs valeur de la carte.",
      ],
      materials: [
        { name: "Puce VRAM compatible (si remplacement)", est_price_eur: 35 },
        { name: "Station BGA (ou prestation pro)", est_price_eur: 80 },
      ],
      estimated_cost_eur: 115,
      estimated_time_min: 180,
    },
    {
      cause_ref: "Alimentation insuffisante / instable",
      steps: [
        "Vérifier que l'alimentation respecte le wattage recommandé pour le GPU.",
        "Contrôler les connecteurs PCIe (pas de daisy-chain sur les cartes gourmandes).",
        "Tester avec une alimentation de qualité connue.",
      ],
      materials: [
        { name: "Câbles PCIe dédiés (si besoin)", est_price_eur: 15 },
      ],
